...
2. Follow the intstructions on https://code.visualstudio.com/docs/cpp/CMake-linux#_select-a-kit and ensure you meet all of the prerequisites
	1. In your terminal you will also need to install cmake
...
3. If done correctly so far, there should be a selection between which file you would like to run
4. Build then run the code from the commands on the bottom bar of VSCode

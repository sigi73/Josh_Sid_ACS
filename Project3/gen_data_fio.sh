...
echo $HEADER > read_4k.txt
fio fio_4k_read --minimal >> read_4k.txt
echo $HEADER > read_32k.txt
fio fio_32k_read --minimal >> read_32k.txt

echo $HEADER > write_4k.txt
fio fio_4k_write --minimal >> write_4k.txt
echo $HEADER > write_32k.txt
fio fio_32k_write --minimal >> write_32k.txt

echo $HEADER > rw_4k.txt
fio fio_4k_rw --minimal >> rw_4k.txt
